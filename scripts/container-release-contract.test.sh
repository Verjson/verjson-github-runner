#!/usr/bin/env bash
set -euo pipefail
ref='e12974b8070030b149ca23edfbf751fe4720b50d'
...
printf '%s  %s\n' 'ab217a262f920891a762988b80105a32642c7c2a731ccbf28729a43c4ad86b89' scripts/container_release_manifest.py | sha256sum --check --strict

#!/usr/bin/env bash
set -euo pipefail
ref='4704880d1a4234dd70d06ee03be0dc8e389cee5c'
printf '%s  %s\n' '1adf2861a2eddc7bb08e63a4b86ac4de0fe924a06a263717ead065a223484b1f' .github/workflows/container-release.yml | sha256sum --check --strict
...
printf '%s  %s\n' '9fc3b6d89bb9946f2279135d481df3e8d208fc75115e24c34dd1989a76bdc432' scripts/container_release_manifest.py | sha256sum --check --strict
